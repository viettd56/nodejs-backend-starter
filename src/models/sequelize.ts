...
import { AppotaPaySubscriptionCycleModel } from './data/AppotaPaySubscriptionCycle.model';

const models = [UserModel, OrderModel, AppotaPaySubscriptionCycleModel];
